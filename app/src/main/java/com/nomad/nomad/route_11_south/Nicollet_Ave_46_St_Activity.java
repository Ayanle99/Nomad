...
public class Nicollet_Ave_46_St_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nicollet__ave_46__st_);


        load_btn = (Button)findViewById(R.id.n46_btn);
        result_Textview = (TextView)findViewById(R.id.n46_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/11/1/46NI").get();
