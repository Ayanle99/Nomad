...
public class Pleasant_Ave_50th_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pleasant__ave_50th_);

        load_btn = (Button)findViewById(R.id.pleasent50_btn);
        result_Textview = (TextView)findViewById(R.id.pleasent50_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/11/1/50PL").get();
