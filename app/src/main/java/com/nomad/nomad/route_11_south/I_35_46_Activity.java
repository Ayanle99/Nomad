...
public class I_35_46_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_i_35_46_);

        load_btn = (Button)findViewById(R.id.i_35_46_btn);
        result_Textview = (TextView)findViewById(R.id.i_35_46_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/11/1/I346").get();
