...
public class ColumbiaHeightsTransitCenterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_columbia_heights_transit_center);

        load_btn = (Button)findViewById(R.id.Columbia_Height_Transit_btn);
        result_Textview = (TextView)findViewById(R.id.Columbia_Height_Transit_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/11/1/41CE").get();
