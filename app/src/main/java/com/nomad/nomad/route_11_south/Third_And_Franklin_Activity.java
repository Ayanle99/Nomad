...
public class Third_And_Franklin_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_third__and__franklin_);

        load_btn = (Button)findViewById(R.id.third_and_frankl_btn);
        result_Textview = (TextView)findViewById(R.id.third_and_frankl_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/11/1/3AFR").get();
