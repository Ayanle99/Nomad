...
public class ON_HActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on__h);


        load_btn = (Button)findViewById(R.id.on_btn);
        result_Textview = (TextView)findViewById(R.id.on_textview);
