...
public class F_15Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_f_15);


        load_btn = (Button)findViewById(R.id.f_15_btn);
        result_Textview = (TextView)findViewById(R.id.f_15_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/2/2/4S15").get();
