...
public class FACAActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_faca);

        load_btn = (Button)findViewById(R.id.faca_btn);
        result_Textview = (TextView)findViewById(R.id.faca_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/2/2/CHFR").get();
