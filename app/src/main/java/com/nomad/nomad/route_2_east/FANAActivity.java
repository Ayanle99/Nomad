...
public class FANAActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fana);


        load_btn = (Button)findViewById(R.id.fana_btn);
        result_Textview = (TextView)findViewById(R.id.fana_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/2/2/NIFR").get();
