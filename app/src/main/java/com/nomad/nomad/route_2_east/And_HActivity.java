...
public class And_HActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_and__h);

        load_btn = (Button)findViewById(R.id.andr_btn);
        result_Textview = (TextView)findViewById(R.id.andr_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/2/2/ANHA").get();
