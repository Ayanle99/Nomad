...
public class Henn22Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_henn22);



        load_btn = (Button)findViewById(R.id.route_2_hen22_btn);
        result_Textview = (TextView)findViewById(R.id.route_2_henn22_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/2/2/22HE").get();
