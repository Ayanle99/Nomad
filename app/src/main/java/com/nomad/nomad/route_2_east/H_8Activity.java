...
public class H_8Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        load_btn = (Button)findViewById(R.id.h_8_btn);
        result_Textview = (TextView)findViewById(R.id.h_8_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/2/2/8EHE").get();
