...
public class Riv25Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_riv25);

        load_btn = (Button)findViewById(R.id.riv25_btn);
        result_Textview = (TextView)findViewById(R.id.riv25_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/2/2/25RV").get();
