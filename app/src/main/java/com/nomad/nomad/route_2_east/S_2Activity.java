...
public class S_2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_s_2);

        load_btn = (Button)findViewById(R.id.S_2_btn);
        result_Textview = (TextView)findViewById(R.id.S_2_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/2/2/7E2E").get();
