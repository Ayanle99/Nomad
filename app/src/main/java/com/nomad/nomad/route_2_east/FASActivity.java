...
public class FASActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        load_btn = (Button)findViewById(R.id.fas_btn);
        result_Textview = (TextView)findViewById(R.id.fas_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/2/2/FRHI").get();
