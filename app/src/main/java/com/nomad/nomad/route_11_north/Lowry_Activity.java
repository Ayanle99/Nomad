...
public class Lowry_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lowry_);

        load_btn = (Button)findViewById(R.id.lowery_btn);
        result_Textview = (TextView)findViewById(R.id.lowery_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/11/4/LW2S").get();
