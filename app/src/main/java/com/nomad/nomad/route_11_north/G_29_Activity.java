...
public class G_29_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g_29_);

        load_btn = (Button)findViewById(R.id.g_29_btn);
        result_Textview = (TextView)findViewById(R.id.g_29_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/11/4/29GR").get();
