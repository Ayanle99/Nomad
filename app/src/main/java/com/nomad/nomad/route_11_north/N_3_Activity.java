...
public class N_3_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_n_3_);

        load_btn = (Button)findViewById(R.id.n_3_btn);
        result_Textview = (TextView)findViewById(R.id.n_3_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/11/4/3SNI").get();
