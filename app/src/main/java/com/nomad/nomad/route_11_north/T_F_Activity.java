...
public class T_F_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_t__f_);

        load_btn = (Button)findViewById(R.id.t_f_btn);
        result_Textview = (TextView)findViewById(R.id.t_f_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/11/4/3AFR").get();
