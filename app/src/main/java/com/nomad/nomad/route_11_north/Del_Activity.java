...
public class Del_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        load_btn = (Button)findViewById(R.id.del_btn);
        result_Textview = (TextView)findViewById(R.id.del_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/11/4/DELA").get();
