...
public class N_G_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_n__g_);



        load_btn = (Button)findViewById(R.id.n_g_btn);
        result_Textview = (TextView)findViewById(R.id.n_g_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/11/4/GRNI").get();
