...
public class Col_H_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_col__h_);

        load_btn = (Button)findViewById(R.id.col_h_btn);
        result_Textview = (TextView)findViewById(R.id.col_h_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/11/4/41CE").get();
