package com.nomad.nomad.route_11_north;
...
public class F_Lake_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_f__lake_);

        load_btn = (Button)findViewById(R.id.f_lake_btn);
        result_Textview = (TextView)findViewById(R.id.f_lake_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/11/4/4ALA").get();
