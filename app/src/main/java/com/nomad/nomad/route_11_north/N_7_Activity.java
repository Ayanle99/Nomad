...
public class N_7_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_n_7_);

        load_btn = (Button)findViewById(R.id.n_7_btn);
        result_Textview = (TextView)findViewById(R.id.n_7_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/11/4/7SNI").get();
