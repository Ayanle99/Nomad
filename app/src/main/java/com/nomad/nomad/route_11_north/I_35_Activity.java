...
public class I_35_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_i_35_);

        load_btn = (Button)findViewById(R.id.i_35_btn);
        result_Textview = (TextView)findViewById(R.id.i_35_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/11/4/I346").get();
