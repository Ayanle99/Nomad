...
public class F_38_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_f_38_);

        load_btn = (Button)findViewById(R.id.f_38_btn);
        result_Textview = (TextView)findViewById(R.id.f_38_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/11/4/384A").get();
