...
public class Franklin_Ave_Chicago_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_franklin__ave__chicago_);

        load_btn = (Button)findViewById(R.id.franklin_ave_chicago_btn);
        result_Textview = (TextView)findViewById(R.id.franklin_ave_chicago_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/2/3/CHFR").get();
