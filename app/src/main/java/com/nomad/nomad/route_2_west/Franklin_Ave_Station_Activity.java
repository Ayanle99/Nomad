...
public class Franklin_Ave_Station_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_franklin__ave__station_);

        load_btn = (Button)findViewById(R.id.franklin_ave_station_btn);
        result_Textview = (TextView)findViewById(R.id.franklin_ave_station_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/2/3/FRHI").get();
