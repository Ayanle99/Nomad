...
public class Onterio_Beacon_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_onterio__beacon_);

        load_btn = (Button)findViewById(R.id.onterio_beacan_btn);
        result_Textview = (TextView)findViewById(R.id.onterio_beacan_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/2/3/ONBE").get();
