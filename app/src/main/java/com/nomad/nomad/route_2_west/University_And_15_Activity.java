...
public class University_And_15_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_university__and_15_);

        load_btn = (Button)findViewById(R.id.university_15_btn);
        result_Textview = (TextView)findViewById(R.id.university_15_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/2/3/15UN").get();
