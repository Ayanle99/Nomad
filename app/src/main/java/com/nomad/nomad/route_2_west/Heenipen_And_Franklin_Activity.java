...
public class Heenipen_And_Franklin_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_heenipen__and__franklin_);

        load_btn = (Button)findViewById(R.id.hennipen_and_franklin_btn);
        result_Textview = (TextView)findViewById(R.id.hennipen_and_franklin_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/2/3/FRHE").get();
