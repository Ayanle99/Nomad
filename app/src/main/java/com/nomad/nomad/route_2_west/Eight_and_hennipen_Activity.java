...
public class Eight_and_hennipen_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eight_and_hennipen_);

        load_btn = (Button)findViewById(R.id.eight_hennipen_btn);
        result_Textview = (TextView)findViewById(R.id.eight_hennipen_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/2/3/8EHE").get();
