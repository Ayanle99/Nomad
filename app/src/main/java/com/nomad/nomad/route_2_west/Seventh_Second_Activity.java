...
public class Seventh_Second_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seventh__second_);

        load_btn = (Button)findViewById(R.id.seventh_and_second_btn);
        result_Textview = (TextView)findViewById(R.id.seventh_and_second_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/2/3/7E2E").get();
