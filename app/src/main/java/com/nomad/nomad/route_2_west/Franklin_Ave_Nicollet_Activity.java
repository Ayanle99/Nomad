package com.nomad.nomad.route_2_west;
...
public class Franklin_Ave_Nicollet_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_franklin__ave__nicollet_);


        load_btn = (Button)findViewById(R.id.franklin_and_nicollet_btn);
        result_Textview = (TextView)findViewById(R.id.franklin_and_nicollet_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/2/3/NIFR").get();
