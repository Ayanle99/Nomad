...
public class Willey_Hall_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_willey__hall_);

        load_btn = (Button)findViewById(R.id.Willey_hall_btn);
        result_Textview = (TextView)findViewById(R.id.Willey_hall_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/2/3/WIHA").get();
