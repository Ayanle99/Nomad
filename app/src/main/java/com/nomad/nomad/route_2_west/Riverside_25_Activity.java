...
public class Riverside_25_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_riverside_25_);

        load_btn = (Button)findViewById(R.id.riverside_and_25_btn);
        result_Textview = (TextView)findViewById(R.id.riverside_and_25_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document doc = Jsoup.connect("http://svc.metrotransit.org/NexTrip/2/3/25RV").get();
